...
{#if showSyncConfirm}
	<div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onclick={() => showSyncConfirm = false} onkeydown={(e) => e.key === 'Escape' && (showSyncConfirm = false)}>
